...
## Try the public beta (Android v1.0.29 · Windows v1.0.29)
...
| **Windows** | [Installer](https://www.supersecurechat.com/downloads/SSC-Setup-1.0.29.exe) (~182 MB) |
...
| **Build track** | v1.0.29 APK + v1.0.29 Windows — installers live on site |
