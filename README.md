...
## Try the public beta (Android v1.0.28 · Windows v1.0.28)
...
| **Windows** | [Installer](https://www.supersecurechat.com/downloads/SSC-Setup-1.0.28.exe) (~182 MB) |
...
| **Build track** | v1.0.28 APK + v1.0.28 Windows — installers live on site |
